...
export const productSlice = createSlice({
  ...
  extraReducers: (builder) => {
    builder
      ...
      // update states of get add product action
      ...
      // update states of edit edit product action
...
export const setLoadingTrueIfCalled = (isCalled) => (dispatch, getSate) => {
  const currentValue = selectLoading(getSate());
